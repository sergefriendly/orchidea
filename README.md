...
Величина $\sqrt{x^2(t)+y^2(t)}$ должна быть константой, поскольку стержень в процессе колебаний не деформируется: не удлиняется и не сжимается. Следовательно в решении либо в уравнении есть подвох.
